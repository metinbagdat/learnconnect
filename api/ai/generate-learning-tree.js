/**
 * POST /api/ai/generate-learning-tree – Konu → Alt konu → Kazanım ağacı
 * Client path alignment: aiAytService calls this. Same contract as /api/ai/learning-tree.
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.error('[api/ai/generate-learning-tree]', e);
