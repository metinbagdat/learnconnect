...
Her konu için alt başlıklar, zorluk, tahmini saat ekle.`
  ...
  yks_full: {
    system: `Sen Türkiye YKS sınav sistemi uzmanı bir eğitim müfredat tasarımcısısın.
MEB ve ÖSYM'nin resmi YKS (TYT + AYT) müfredatına göre eksiksiz içerik üretiyorsun.
Yanıtını sadece geçerli JSON formatında ver. Markdown kullanma.`,
    
    user: `YKS için eksiksiz müfredat oluştur (TYT + AYT birleşik).
...
**AYT Dersleri:**
- Matematik (40 soru)
- Fizik, Kimya, Biyoloji (40 soru toplam)
- Türk Dili ve Edebiyatı (24 soru)
- Tarih, Coğrafya, Felsefe, Din Kültürü (56 soru toplam)
