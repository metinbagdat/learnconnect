...
-- NOTE: FOR SELECT / FOR UPDATE must stay on one line with FOR — a line break
-- between FOR and UPDATE makes Postgres parse UPDATE as a new statement (42601 near "to").
